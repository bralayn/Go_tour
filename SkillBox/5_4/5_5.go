...
func main() {
	...
	switch {
	case interestRate1 == interestRate2 && interestRate2 == interestRate3:
		fmt.Println("--- All interest rates are equal !!! ---")
		goto endPrg
	case interestRate1 > interestRate2 && interestRate1 > interestRate3:
	...
	case interestRate2 > interestRate1 && interestRate2 > interestRate3:
